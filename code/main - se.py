...
# 注意力机制SE
def se_block_1(input_feature, ratio=8):
...
class CNN(keras.Model):
    ...
    def train(self, train_db, test_db, epochs):
        ...
        # np.savetxt ('./results/cnn_eca/eca_560.txt',af)
        # np.savetxt('./results/cnn_eca/eca_loss_560.txt', los)
        np.savetxt('./results/cnn_se/pred.txt', pred)
        np.savetxt('./results/cnn_se/label.txt', label)
        # print(pred)
        # return pred
