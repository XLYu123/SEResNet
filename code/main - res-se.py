...
data_y = np.array([1] * 700 + [2] * 700 + [3] * 700+[4] * 700 + [5] * 700 + [6] * 700)
# print(data_y.shape)
...
data_y_T = np.array([0] * 300 + [1] * 300 + [2] * 300 + [3] * 300+[4] * 300 + [5] * 300 + [6] * 300)
...
class CNN(keras.Model):
    ...
    def train(self, train_db, test_db, epochs):
        ...
        # tf.reduce_mean(af)
        # np.savetxt ('./results/cnn_resnet_se/res_se_880.txt',af)
        # np.savetxt('./results/cnn_resnet_se/res_se_loss_880.txt',los)
        np.savetxt('./results/cnn_resnet_se/pred.txt', pred)
        np.savetxt('./results/cnn_resnet_se/label.txt', label)
        # print(label)
        # print(pred)
...
cnn = CNN(input_shape)
cnn.train(train_db, test_db, epochs=20)